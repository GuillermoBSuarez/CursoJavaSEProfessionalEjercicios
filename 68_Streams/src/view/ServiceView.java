...
public class ServiceView {
	...
	static ServicePedidos service = new ServicePedidos();
	...
	static void grabarPedido() {
		...
		try {
			...
			service.guardarPedido(producto, fecha, precio);
	...
	static void mostrarPedidos() {
		...
		List<Pedido> pedidos = service.pedidosPrecio(precioMax);
		pedidos.forEach(p -> {					// PRIMERA VERSIÓN: for(Pedido p:pedidos) {
	...
	static void mostrarPedidosAnteriores() {
		...
		List<Pedido> pedidos = service.anteriores(meses);
		pedidos.forEach(p -> {					// PRIMERA VERSIÓN: for(Pedido p:pedidos) {
			System.out.println("Producto: " + p.getProducto());
			System.out.println("Fecha: " + p.getFechaPedido());
			System.out.println("Precio: " + p.getPrecio());
