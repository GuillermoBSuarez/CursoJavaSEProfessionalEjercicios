...
public class ServiceProductos {
	...
	public void ordenarPorPrecio() {
		...
		No funciona porque la resta devuelve un int y los precios son double y no se pueden convertir.
		Tampoco se puede hacer casting porque a lo mejor la diferencia está en los decimales,
		que se pierden en el casting. Se pueden convertir a Double.valueOf y hacer un compareTo,
		pero ya la propia clase tiene un método de comparación de dos doubles primitivos: */
